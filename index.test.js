...
describe('index.html', () => {
    ...
    it('renders the correct four images in body', () => {
        const expectedImgSrcsArr = [
            "design-files/ui-i-bakery-main-header.png",
            "design-files/ui-i-bakery-cupcake-i.png",
            "design-files/ui-i-bakery-cookies.png", 
            "design-files/ui-i-bakery-celebrate.png"
        ];
